<template>
    ...
    <VueUploadComponent name="Upload file" @change="fileUploaded" drop="true"
        class="inline-flex items-center justify-center px-5 py-2 text-sm font-semibold tracking-wide text-white transition-all duration-300 ease-out rounded-full shadow-sm bg-indigo-600 hover:shadow-md hover:bg-indigo-700 hover:-translate-y-0.5 active:scale-95 cursor-pointer min-w-max ml-1 mr-2">
