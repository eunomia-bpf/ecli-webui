...
<template>
    <button 
        :class="[
            'inline-flex items-center justify-center px-5 py-2 text-sm font-semibold tracking-wide transition-all duration-300 ease-out rounded-full active:scale-95 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed',
            props.text 
